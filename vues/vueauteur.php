...
<div class="tab-content">
    <div class="tab-pane show active" id="ajouter">
        <form action="index.php?action=ajouter_chapitre" method="post">
            ...
            <?php
                while ( $donnes = $chapitres->fetch())
                {
                    echo '<li class="list-group-item">
                        <h5>' .$donnes['nom'] . '</h5>
                        <a href="index.php?action=modifier_chapitre&amp;id=' .$donnes['id'] . '">Modifier</a>
                        <a href="index.php?action=effacer_chapitre&amp;id=' .$donnes['id'] . '">Effacer</a>
                    </li>';
                }
            ?>
        </ul>
    ...
    <ul class="list-group list-group-flush mb-5">
        <?php
            while ( $donnes = $commentaires->fetch()){
                ...
                echo '<a href="index.php?action=modifier_commentaire&amp;id=' .$donnes['id'] . '">Modifier</a>';
